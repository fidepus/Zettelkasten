...
//	Button 		addButton, deleteButton, retrieveButton, updateButton;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
    	...
    	try
    	{
    		...
    		super.onCreate(savedInstanceState);
    		setContentView(R.layout.einmal);
...
//	        addButtonListeners();
    ...
    private void retrieveRow()
    {
    	try
    	{
    		...
    		row = db.getGelerntRowsAsArrays(1);
...
//    		updateTextFieldTwo.setText((String)row.get(2));
    ...
    private void updateTable()
    {
    	...
    	ArrayList<ArrayList<Object>> data = db.getGelerntRowsAsArrays(1);
...
//msg.show();
    	...
    	builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
    	      public void onClick(DialogInterface dialog, int which) {
    	      	...
    	      	Toast msg = Toast.makeText(Einmal.this,
