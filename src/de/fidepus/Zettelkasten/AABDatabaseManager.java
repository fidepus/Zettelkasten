...
public class AABDatabaseManager
{
	...
	private final String DB_NAME = "zettelkasten";
	private final int DB_VERSION = 1;
 
	// These constants are specific to the database table.  They should be
	// changed to suit your needs.
	private final String TABLE_NAME = "zettelkasten_englisch";
	private final String TABLE_ROW_ID = "_id";
	private final String TABLE_ROW_ONE = "de";
	private final String TABLE_ROW_TWO = "en";
	private final String TABLE_ROW_THREE = "gelernt";
